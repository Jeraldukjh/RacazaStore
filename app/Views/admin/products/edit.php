...
<head>
    ...
    <title>Edit Product - Racaza Store</title>
    <style>
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="card-body">
                ...
                <form action="<?= site_url('product/update/' . $product['id']) ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="product_name" name="product_name" value="<?= esc($product['product_name']) ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="expiry_date" name="expiry_date" value="<?= esc($product['expiry_date'] ?? '') ?>">
                    </div>
